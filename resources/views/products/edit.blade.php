                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update', $product->id) }}" method="post" >
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" value="{{ old('description', $product->description) }}"  class="form-control" id="" placeholder="Enter Description" cols="30"
                                    rows="10"></textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control form-control-lg" name="image"
                                    ...
                                    <img src="{{ asset('uploads/products/' . $product->image) }}"
                                        alt="" class="my-2" style="width: 20rem; height: auto;" >
                                @endif
                            </div>
